...
import { CompanyDto, CompanyRequestDto, AnafApiResponseDto, AnafCompanyFoundDto } from './dto/company.dto';
...
export class CompanyService {
  ...
  private async fetchFromAnafApi(cui: number, data: string): Promise<AnafApiResponseDto> {
    try {
